...
class wave{
    ...
    public:
        ...
        ~wave() = default;
        std::vector<enemy_type> get_coming_enemies(){ return _coming_enemies; }
        float get_spawn_cooldown(){ return _spawn_cooldown; }
        int get_total_enemies(){ return _coming_enemies.size(); }
